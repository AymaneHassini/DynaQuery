...
#     *   Partiality – Some, but not all, of the required "AND" conditions are confirmed, or one is missing/uncertain.
#     *   Qualification – A condition is confirmed but with a limitation, drawback, or flaw.
# 
...
def classify_with_llm(user_query: str, llm_rationale: str, classifier_chain) -> Optional[ClassificationDecision]:
    ...
    try:
        ...
        print("📝 [DEBUG] Full prompt for Classification LLM:\n", full_prompt)
