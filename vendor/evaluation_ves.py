# ==============================================================================
# This script is a modified version of an evaluation script (evaluation_ves.py) from the official
# BIRD Text-to-SQL benchmark.
#
# Original Source: https://github.com/AlibabaResearch/DAMO-ConvAI/blob/main/bird/llm/src/evaluation_ves.py
# Original Authors: Jinyang Li, Binyuan Hui, et al.
# License: MIT License
#
# A copy of the original license is available in the project's LICENSES directory.
# This script has been modified to add an '--output_path' argument to save
# detailed, per-query JSON results for post-processing.
# ==============================================================================
import os
import pdb
import sys
...
if __name__ == '__main__':
    ...
    args_parser.add_argument('--output_path', type=str, default=None, help='Path to save the detailed JSON results file.')
    ...
    if args.output_path:
        ...
        print("Successfully saved detailed results.")
